...
<!-- Mirrored from appco.themetags.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Feb 2020 07:22:34 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!--ytplayer css-->
    <link rel="stylesheet" href="{{asset('landing/css/jquery.mb.YTPlayer.min.css')}}">
    <!--Owl carousel css-->
...
<header class="header">
    ...
    <nav class="navbar navbar-expand-lg fixed-top bg-transparent">
        <div class="container">
            <h5 class="text-white mt-3">NURISPERPUS</h5>
            ...
            <div class="collapse navbar-collapse main-menu" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#about">Tentang Aplikasi</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#features">Fitur Aplikasi</a>
                    </li>
                    <li class="nav-item">
...
<div class="main">
    ...
    <section class="hero-section pt-100 background-img"
            ...
            <div class="row align-items-center justify-content-between py-5">
                <div class="col-md-7 col-lg-6">
                    <div class="hero-content-left text-white">
                        <h1 class="text-white"><span>Selamat Datang</span> Di Aplikasi NURISPERPUS</h1>
        ...
        <div class="bottom-img-absolute">
            <img src="{{asset('landing/img/hero-bg-shape-1.svg')}}" alt="wave shape" class="img-fluid">
        </div>
    </section>
    <!--hero section end-->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-8">
                    <div class="section-heading text-center mb-5">
                        <h2>Mengapa harus menggunakan NURISPERPUS?</h2>
                        <p class="lead" style="font-size: 15px;">
                            Tujuan Aplikasi ini di buat untuk mempermudah siswa / siswi SMK NURUL ISLAM CIANJUR Untuk mengetahui informasi perpustakaan, untuk menuliskan resume hasil literasi, dan untuk membudayakan gemar membaca.
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <div id="accordion-1" class="accordion accordion-faq">
                            ...
                            <div class="card">
                                <div class="card-header py-4" id="heading-1-1" data-toggle="collapse" role="button"
                                    ...
                                    <h6 class="mb-0"><span class="ti-receipt mr-3"></span> Lihat Buku?</h6>
                                </div>
                                <div id="collapse-1-1" class="collapse" aria-labelledby="heading-1-1"
                                     data-parent="#accordion-1">
                                    <div class="card-body">
                                        <p>Lihat Buku merupakan fitur di aplikasi ini untuk melihat buku yang ada di perpustakaan.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Accordion card 2 -->
                            <div class="card">
                                <div class="card-header py-4" id="heading-1-2" data-toggle="collapse" role="button"
                                    ...
                                    <h6 class="mb-0"><span class="ti-gallery mr-3"></span> Unggah Karya?</h6>
                                </div>
                                <div id="collapse-1-2" class="collapse" aria-labelledby="heading-1-2"
                                     data-parent="#accordion-1">
                                    <div class="card-body">
                                        <p>Unggah Karya merupakan fitur di aplikasi untuk mengunggah karya yang dimiliki siswa / siswi yang dapat di lihat oleh siswa / siswi lain, terdapat 3 karya yang tersedia yaitu cerpen, novel dan puisi.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Accordion card 3 -->
                            <div class="card">
                                <div class="card-header py-4" id="heading-1-3" data-toggle="collapse" role="button"
                                    ...
                                    <h6 class="mb-0"><span class="ti-wallet mr-3"></span> Resume Literasi?
                                    </h6>
                                </div>
                                <div id="collapse-1-3" class="collapse" aria-labelledby="heading-1-3"
                                     data-parent="#accordion-1">
                                    <div class="card-body">
                                        <p>Resume Literasi bertujuan untuk mencatatkan seluruh hasil literasi siswa / siswi.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="section-heading text-center">
                        <h2 class="text-white">Screenshoot Aplikasi</h2>
                    </div>
                </div>
            </div>
    ...
    <div class="footer-bottom gray-light-bg pt-4 pb-4">
        <div class="container">
            <div class="row text-center justify-content-center">
                <div class="col-md-6 col-lg-5"><p class="copyright-text pb-0 mb-0">DESIGN BY | RPL SMAKNIS TEAM 2020</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- Mirrored from appco.themetags.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Feb 2020 07:22:42 GMT -->
</html>