...
<h5 class="mb-4" style="font-weight: bold; color:#000;">Baca Cerpen ( Cerita Pendek )</h5>

@if($count > 0)

@foreach($cerpen as $n)
<div class="card mb-3">
    <img src="/user/image/cerpen/{{$n->cerpen_gambar}}" style="width: 100%; height: 240px;" alt="" class="img-responsive">
    <div class="card-body">
        
        <h4 style="font-weight: bold; color:#000;">{{$n->cerpen_judul}}</h4>
        
        <p class="mb-0" style="font-size: 15px;color:#000;">Karya : {{$n->cerpen_karya}}</p>
